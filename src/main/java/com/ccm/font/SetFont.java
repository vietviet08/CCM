...
//	public static Font font2;
	...
	public static Font fontDetails_1() {
		Font f1 = null;
		try {
			File fontStyle = new File("/font/Roboto-Light.ttf");
	...
	public static Font fontCategory() {
		Font f = null;
		try {
			File fontStyle1 = new File("/font/Roboto-Light.ttf");
	...
	public static Font fontHeaderTable() {
		Font f = null;
		try {
			File fontStyle1 = new File("/font/Roboto-Bold.ttf");
	...
	public static com.itextpdf.text.Font fontTNR() {
		...
		try {
			f = new com.itextpdf.text.Font(
					BaseFont.createFont("/font/SVN-Times-New-Roman.ttf", BaseFont.IDENTITY_H, true), 12);
		} catch (Exception e) {
			System.out.println(e);
		}
		return f;
	...
	public static com.itextpdf.text.Font fontTNRBoldTitle() {
		...
		try {
			f = new com.itextpdf.text.Font(
					BaseFont.createFont("/font/SVN-Times-New-Roman-Bold.ttf", BaseFont.IDENTITY_H, true), 18);
		} catch (Exception e) {
			System.out.println(e);
		}
		return f;
	...
	public static com.itextpdf.text.Font fontTNRBoldNameCompany() {
		...
		try {
			f = new com.itextpdf.text.Font(
					BaseFont.createFont("/font/SVN-Times-New-Roman-Bold.ttf", BaseFont.IDENTITY_H, true), 20);
		} catch (Exception e) {
			System.out.println(e);
		}
		return f;
	...
	public static com.itextpdf.text.Font fontTNRBold() {
		...
		try {
			f = new com.itextpdf.text.Font(
					BaseFont.createFont("/font/SVN-Times-New-Roman-Bold.ttf", BaseFont.IDENTITY_H, true), 12);
		} catch (Exception e) {
			System.out.println(e);
		}
		return f;
	...
	public static com.itextpdf.text.Font fontTNRItalic() {
		...
		try {
			f = new com.itextpdf.text.Font(
					BaseFont.createFont("/font/SVN-Times-New-Roman-Italic.ttf", BaseFont.IDENTITY_H, true), 10);
		} catch (Exception e) {
			System.out.println(e);
		}
		return f;
